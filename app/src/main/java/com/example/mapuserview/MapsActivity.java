package com.example.mapuserview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                databaseLatitude = snapshot.child("latitude").getValue().toString();
                databaseLongitude = snapshot.child("longitude").getValue().toString();
...
//                    marker.setRotation(location.getBearing());
                ...
                editTextLongitude.setText(databaseLongitude);
            }
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(@NonNull Location location) {
                try {
//                    editTextLatitude.setText((int) Double.parseDouble(databaseLatitude));
//                    editTextLongitude.setText((int) Double.parseDouble(databaseLongitude));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
